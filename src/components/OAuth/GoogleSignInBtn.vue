<script setup lang="ts">
    import { checkSignIn, googleSignIn } from './OAuth'
    import { ref, onMounted } from 'vue'
    import { useUserDataStore } from '@/stores/UserDataStore';

    const usrDataStore = useUserDataStore()
    ...
    onMounted(() => {
        if (signInBtn.value !== undefined){
            signInBtn.value.onclick = async () => { await googleSignIn(); usrDataStore.signedIn = true;}
        }
    })
</script>
...
<template>
    <!--
      SIGN IN WITH GOOGLE BTN APPROVED BY GOOGLE BRAND
      https://developers.google.com/identity/branding-guidelines
    -->
    <button class="gsi-material-button" ref="signInBtn">
